...
# 6 Domain Categories for Li-ion Batteries
QDWA_CATEGORIES = {
    "Performance Metrics": {
...
def render_qdwa_sankey(
    ...
    for i, term in enumerate(terms):
        ...
        if len(clean_term) > 24:
            clean_term = clean_term[:21] + "..."
    ...
    cat_indices = {}
    for cat in SIX_CATEGORIES:
        labels.append(CATEGORY_DISPLAY[cat])
    ...
    fig = go.Figure(go.Sankey(
        ...
        link=dict(
            ...
            value=values,
            color=link_colors,
            hovertemplate="<b>Weight:</b> %{value:.4f}<extra></extra>",
        ),
    ))
    fig.update_layout(
    ...
    fig = apply_chart_style(fig, theme=theme, is_axial=False)
    st.plotly_chart(fig, use_container_width=True)
...
def render_qdwa_radar_chart(
    ...
    fig = apply_chart_style(fig, theme=theme, is_axial=False, chart_type="radar")
    st.plotly_chart(fig, use_container_width=True)
...
def render_qdwa_bar_comparison(
    ...
    with col1:
        ...
        fig1 = apply_chart_style(fig1, theme=theme, chart_type="bar")
    ...
    with col2:
        ...
        fig2 = apply_chart_style(fig2, theme=theme, chart_type="bar")
...
# ============================================================================
# QUANTITATIVE NER MODULE (MicroTransformer Quantitative NER)
# ============================================================================
# ============================================================================
# MICROTRANSFORMER QUANTITATIVE NER MODULE
# ============================================================================
# Extracts, normalizes, and predicts numerical battery metrics
# ============================================================================

# --- Data Schema ---

class MetricType(Enum):
    """Battery quantitative metric types."""
    # Energy metrics
    ...
    # Thermal metrics
    THERMAL_STABILITY_TEMP = "thermal_stability_temp"
    ...
    # Cell-level metrics
    NP_RATIO = "np_ratio"
    FIRST_CYCLE_EFFICIENCY = "first_cycle_efficiency"
...
METRIC_CANONICAL_UNITS: Dict[MetricType, str] = {
    MetricType.GRAVIMETRIC_ENERGY_DENSITY: "Wh/kg",
    MetricType.VOLUMETRIC_ENERGY_DENSITY: "Wh/L",
    MetricType.SPECIFIC_CAPACITY: "mAh/g",
    MetricType.AREAL_CAPACITY: "mAh/cm²",
    MetricType.VOLUMETRIC_CAPACITY: "mAh/cm³",
    MetricType.GRAVIMETRIC_POWER_DENSITY: "W/kg",
    MetricType.VOLUMETRIC_POWER_DENSITY: "W/L",
    MetricType.CYCLE_LIFE: "cycles",
    MetricType.CALENDAR_LIFE: "years",
    MetricType.CAPACITY_RETENTION: "%",
    MetricType.COULOMBIC_EFFICIENCY: "%",
    MetricType.ENERGY_EFFICIENCY: "%",
    MetricType.C_RATE: "C",
    MetricType.CHARGE_RATE: "C",
    MetricType.DISCHARGE_RATE: "C",
    MetricType.THERMAL_STABILITY_TEMP: "°C",
    MetricType.OPERATING_TEMP_RANGE: "°C",
    MetricType.IMPEDANCE: "Ω",
    MetricType.INTERNAL_RESISTANCE: "mΩ",
    MetricType.ELECTRODE_DENSITY: "g/cm³",
    MetricType.POROSITY: "%",
    MetricType.TORTUOSITY: "dimensionless",
    MetricType.ELECTRODE_THICKNESS: "μm",
    MetricType.PARTICLE_SIZE: "nm",
    MetricType.IONIC_CONDUCTIVITY: "mS/cm",
    MetricType.ELECTRONIC_CONDUCTIVITY: "S/cm",
    MetricType.TRANSFERENCE_NUMBER: "dimensionless",
    MetricType.VOLTAGE_WINDOW: "V",
    MetricType.OCV: "V",
    MetricType.NP_RATIO: "dimensionless",
    MetricType.FIRST_CYCLE_EFFICIENCY: "%",
    MetricType.CAPACITY_FADE_RATE: "%/cycle",
    MetricType.MASS_LOADING: "mg/cm²",
    MetricType.COMPACTION_DENSITY: "g/cm³",
    MetricType.COATING_SPEED: "m/min",
    MetricType.VOLUME_EXPANSION: "%",
    MetricType.THICKNESS_CHANGE: "%",
}

# Human-readable display names
METRIC_DISPLAY_NAMES: Dict[MetricType, str] = {
    MetricType.GRAVIMETRIC_ENERGY_DENSITY: "Gravimetric Energy Density",
    MetricType.VOLUMETRIC_ENERGY_DENSITY: "Volumetric Energy Density",
    MetricType.SPECIFIC_CAPACITY: "Specific Capacity",
    MetricType.AREAL_CAPACITY: "Areal Capacity",
    MetricType.VOLUMETRIC_CAPACITY: "Volumetric Capacity",
    MetricType.GRAVIMETRIC_POWER_DENSITY: "Gravimetric Power Density",
    MetricType.VOLUMETRIC_POWER_DENSITY: "Volumetric Power Density",
    MetricType.CYCLE_LIFE: "Cycle Life",
    MetricType.CALENDAR_LIFE: "Calendar Life",
    MetricType.CAPACITY_RETENTION: "Capacity Retention",
    MetricType.COULOMBIC_EFFICIENCY: "Coulombic Efficiency",
    MetricType.ENERGY_EFFICIENCY: "Energy Efficiency",
    MetricType.C_RATE: "C-Rate",
    MetricType.CHARGE_RATE: "Charge Rate",
    MetricType.DISCHARGE_RATE: "Discharge Rate",
    MetricType.THERMAL_STABILITY_TEMP: "Thermal Stability Temp",
    MetricType.OPERATING_TEMP_RANGE: "Operating Temp Range",
    MetricType.IMPEDANCE: "Impedance",
    MetricType.INTERNAL_RESISTANCE: "Internal Resistance",
    MetricType.ELECTRODE_DENSITY: "Electrode Density",
    MetricType.POROSITY: "Porosity",
    MetricType.TORTUOSITY: "Tortuosity",
    MetricType.ELECTRODE_THICKNESS: "Electrode Thickness",
    MetricType.PARTICLE_SIZE: "Particle Size",
    MetricType.IONIC_CONDUCTIVITY: "Ionic Conductivity",
    MetricType.ELECTRONIC_CONDUCTIVITY: "Electronic Conductivity",
    MetricType.TRANSFERENCE_NUMBER: "Transference Number",
    MetricType.VOLTAGE_WINDOW: "Voltage Window",
    MetricType.OCV: "Open Circuit Voltage",
    MetricType.NP_RATIO: "N/P Ratio",
    MetricType.FIRST_CYCLE_EFFICIENCY: "First Cycle Efficiency",
    MetricType.CAPACITY_FADE_RATE: "Capacity Fade Rate",
    MetricType.MASS_LOADING: "Mass Loading",
    MetricType.COMPACTION_DENSITY: "Compaction Density",
    MetricType.COATING_SPEED: "Coating Speed",
    MetricType.VOLUME_EXPANSION: "Volume Expansion",
    MetricType.THICKNESS_CHANGE: "Thickness Change",
}
...
class TestConditions:
    ...
    def to_dict(self) -> Dict:
        ...
        if self.c_rate is not None:
            result["c_rate"] = self.c_rate
        if self.voltage_range:
            result["voltage_range"] = list(self.voltage_range)
        if self.pressure is not None:
            result["pressure"] = self.pressure
        if self.electrolyte:
            result["electrolyte"] = self.electrolyte
        if self.cell_format:
            result["cell_format"] = self.cell_format
...
class UnitNormalizer:
    ...
    UNIT_CONVERSIONS: Dict[Tuple[MetricType, str], float] = {
        # Energy density
        (MetricType.GRAVIMETRIC_ENERGY_DENSITY, "Wh/kg"): 1.0,
        (MetricType.GRAVIMETRIC_ENERGY_DENSITY, "wh/kg"): 1.0,
        (MetricType.GRAVIMETRIC_ENERGY_DENSITY, "Wh kg-1"): 1.0,
        (MetricType.GRAVIMETRIC_ENERGY_DENSITY, "kWh/kg"): 1000.0,
        (MetricType.GRAVIMETRIC_ENERGY_DENSITY, "J/g"): 1.0 / 3.6,
        (MetricType.GRAVIMETRIC_ENERGY_DENSITY, "kJ/kg"): 1.0 / 3.6,
        (MetricType.GRAVIMETRIC_ENERGY_DENSITY, "MJ/kg"): 1000.0 / 3.6,

        (MetricType.VOLUMETRIC_ENERGY_DENSITY, "Wh/L"): 1.0,
        (MetricType.VOLUMETRIC_ENERGY_DENSITY, "wh/l"): 1.0,
        (MetricType.VOLUMETRIC_ENERGY_DENSITY, "Wh/l"): 1.0,
        (MetricType.VOLUMETRIC_ENERGY_DENSITY, "kWh/L"): 1000.0,
        (MetricType.VOLUMETRIC_ENERGY_DENSITY, "Wh/m³"): 1e-3,
        (MetricType.VOLUMETRIC_ENERGY_DENSITY, "kWh/m³"): 1.0,
        (MetricType.VOLUMETRIC_ENERGY_DENSITY, "MJ/L"): 1000.0 / 3.6,

        # Capacity
        (MetricType.SPECIFIC_CAPACITY, "mAh/g"): 1.0,
        (MetricType.SPECIFIC_CAPACITY, "mah/g"): 1.0,
        (MetricType.SPECIFIC_CAPACITY, "Ah/kg"): 1.0,
        (MetricType.SPECIFIC_CAPACITY, "mAh/g-1"): 1.0,
        (MetricType.SPECIFIC_CAPACITY, "C/g"): 26.8,
        (MetricType.SPECIFIC_CAPACITY, "mA h/g"): 1.0,

        (MetricType.AREAL_CAPACITY, "mAh/cm²"): 1.0,
        (MetricType.AREAL_CAPACITY, "mAh/cm2"): 1.0,
        (MetricType.AREAL_CAPACITY, "mAh/cm-2"): 1.0,
        (MetricType.AREAL_CAPACITY, "Ah/m²"): 100.0,

        # Power density
        (MetricType.GRAVIMETRIC_POWER_DENSITY, "W/kg"): 1.0,
        (MetricType.GRAVIMETRIC_POWER_DENSITY, "w/kg"): 1.0,
        (MetricType.GRAVIMETRIC_POWER_DENSITY, "kW/kg"): 1000.0,
        (MetricType.GRAVIMETRIC_POWER_DENSITY, "W/g"): 1000.0,

        (MetricType.VOLUMETRIC_POWER_DENSITY, "W/L"): 1.0,
        (MetricType.VOLUMETRIC_POWER_DENSITY, "kW/L"): 1000.0,

        # Cycle life
        (MetricType.CYCLE_LIFE, "cycles"): 1.0,
        (MetricType.CYCLE_LIFE, "cycle"): 1.0,
        (MetricType.CYCLE_LIFE, "c"): 1.0,

        # Calendar life
        (MetricType.CALENDAR_LIFE, "years"): 1.0,
        (MetricType.CALENDAR_LIFE, "months"): 1.0 / 12,
        (MetricType.CALENDAR_LIFE, "days"): 1.0 / 365.25,

        # Percentage metrics
        (MetricType.CAPACITY_RETENTION, "%"): 1.0,
        (MetricType.COULOMBIC_EFFICIENCY, "%"): 1.0,
        (MetricType.ENERGY_EFFICIENCY, "%"): 1.0,
        (MetricType.POROSITY, "%"): 1.0,
        (MetricType.FIRST_CYCLE_EFFICIENCY, "%"): 1.0,
        (MetricType.CAPACITY_FADE_RATE, "%/cycle"): 1.0,
        (MetricType.VOLUME_EXPANSION, "%"): 1.0,
        (MetricType.THICKNESS_CHANGE, "%"): 1.0,

        # C-rate
        (MetricType.C_RATE, "C"): 1.0,
        (MetricType.C_RATE, "c"): 1.0,
        (MetricType.CHARGE_RATE, "C"): 1.0,
        (MetricType.DISCHARGE_RATE, "C"): 1.0,

        # Temperature
        (MetricType.THERMAL_STABILITY_TEMP, "°C"): 1.0,
        (MetricType.THERMAL_STABILITY_TEMP, "oC"): 1.0,
        (MetricType.THERMAL_STABILITY_TEMP, "K"): 1.0,  # Approximate, ignoring offset
        (MetricType.OPERATING_TEMP_RANGE, "°C"): 1.0,

        # Impedance
        (MetricType.IMPEDANCE, "Ω"): 1.0,
        (MetricType.IMPEDANCE, "ohm"): 1.0,
        (MetricType.IMPEDANCE, "kΩ"): 1000.0,
        (MetricType.IMPEDANCE, "mΩ"): 1e-3,
        (MetricType.INTERNAL_RESISTANCE, "mΩ"): 1.0,
        (MetricType.INTERNAL_RESISTANCE, "Ω"): 1000.0,
        (MetricType.INTERNAL_RESISTANCE, "ohm"): 1000.0,

        # Density
        (MetricType.ELECTRODE_DENSITY, "g/cm³"): 1.0,
        (MetricType.ELECTRODE_DENSITY, "g/cm3"): 1.0,
        (MetricType.ELECTRODE_DENSITY, "kg/m³"): 1e-3,
        (MetricType.COMPACTION_DENSITY, "g/cm³"): 1.0,

        # Thickness
        (MetricType.ELECTRODE_THICKNESS, "μm"): 1.0,
        (MetricType.ELECTRODE_THICKNESS, "um"): 1.0,
        (MetricType.ELECTRODE_THICKNESS, "mm"): 1000.0,
        (MetricType.ELECTRODE_THICKNESS, "nm"): 1e-3,

        # Particle size
        (MetricType.PARTICLE_SIZE, "nm"): 1.0,
        (MetricType.PARTICLE_SIZE, "μm"): 1000.0,
        (MetricType.PARTICLE_SIZE, "um"): 1000.0,
        (MetricType.PARTICLE_SIZE, "mm"): 1e6,

        # Conductivity
        (MetricType.IONIC_CONDUCTIVITY, "mS/cm"): 1.0,
        (MetricType.IONIC_CONDUCTIVITY, "S/cm"): 1000.0,
        (MetricType.IONIC_CONDUCTIVITY, "S/m"): 10.0,
        (MetricType.ELECTRONIC_CONDUCTIVITY, "S/cm"): 1.0,
        (MetricType.ELECTRONIC_CONDUCTIVITY, "S/m"): 1e-2,

        # Voltage
        (MetricType.VOLTAGE_WINDOW, "V"): 1.0,
        (MetricType.VOLTAGE_WINDOW, "v"): 1.0,
        (MetricType.VOLTAGE_WINDOW, "mV"): 1e-3,
        (MetricType.OCV, "V"): 1.0,
        (MetricType.OCV, "v"): 1.0,

        # Mass loading
        (MetricType.MASS_LOADING, "mg/cm²"): 1.0,
        (MetricType.MASS_LOADING, "mg/cm2"): 1.0,
        (MetricType.MASS_LOADING, "g/m²"): 0.1,
        (MetricType.MASS_LOADING, "kg/m²"): 100.0,

        # Dimensionless
        (MetricType.TORTUOSITY, "dimensionless"): 1.0,
        (MetricType.TRANSFERENCE_NUMBER, "dimensionless"): 1.0,
        (MetricType.NP_RATIO, "dimensionless"): 1.0,

        # Speed
        (MetricType.COATING_SPEED, "m/min"): 1.0,
        (MetricType.COATING_SPEED, "mm/s"): 0.06,
    }
    ...
    def infer_metric_from_unit(cls, unit: str) -> Optional[MetricType]:
        unit_to_metrics = {
            "Wh/kg": [MetricType.GRAVIMETRIC_ENERGY_DENSITY],
            "Wh/L": [MetricType.VOLUMETRIC_ENERGY_DENSITY],
            "kWh/kg": [MetricType.GRAVIMETRIC_ENERGY_DENSITY],
            "kWh/L": [MetricType.VOLUMETRIC_ENERGY_DENSITY],
            "J/g": [MetricType.GRAVIMETRIC_ENERGY_DENSITY],
            "kJ/kg": [MetricType.GRAVIMETRIC_ENERGY_DENSITY],
            "mAh/g": [MetricType.SPECIFIC_CAPACITY],
            "Ah/kg": [MetricType.SPECIFIC_CAPACITY],
            "mAh/cm²": [MetricType.AREAL_CAPACITY],
            "C/g": [MetricType.SPECIFIC_CAPACITY],
            "W/kg": [MetricType.GRAVIMETRIC_POWER_DENSITY],
            "kW/kg": [MetricType.GRAVIMETRIC_POWER_DENSITY],
            "W/L": [MetricType.VOLUMETRIC_POWER_DENSITY],
            "cycles": [MetricType.CYCLE_LIFE],
            "years": [MetricType.CALENDAR_LIFE],
            "months": [MetricType.CALENDAR_LIFE],
            "days": [MetricType.CALENDAR_LIFE],
            "%": [MetricType.CAPACITY_RETENTION, MetricType.COULOMBIC_EFFICIENCY,
                  MetricType.ENERGY_EFFICIENCY, MetricType.POROSITY,
                  MetricType.FIRST_CYCLE_EFFICIENCY, MetricType.VOLUME_EXPANSION,
                  MetricType.THICKNESS_CHANGE],
            "C": [MetricType.C_RATE, MetricType.CHARGE_RATE, MetricType.DISCHARGE_RATE],
            "°C": [MetricType.THERMAL_STABILITY_TEMP, MetricType.OPERATING_TEMP_RANGE],
            "K": [MetricType.THERMAL_STABILITY_TEMP],
            "Ω": [MetricType.IMPEDANCE],
            "ohm": [MetricType.IMPEDANCE],
            "mΩ": [MetricType.INTERNAL_RESISTANCE],
            "g/cm³": [MetricType.ELECTRODE_DENSITY, MetricType.COMPACTION_DENSITY],
            "kg/m³": [MetricType.ELECTRODE_DENSITY],
            "μm": [MetricType.ELECTRODE_THICKNESS],
            "mm": [MetricType.ELECTRODE_THICKNESS],
            "nm": [MetricType.PARTICLE_SIZE],
            "mS/cm": [MetricType.IONIC_CONDUCTIVITY],
            "S/cm": [MetricType.ELECTRONIC_CONDUCTIVITY, MetricType.IONIC_CONDUCTIVITY],
            "S/m": [MetricType.IONIC_CONDUCTIVITY, MetricType.ELECTRONIC_CONDUCTIVITY],
            "V": [MetricType.VOLTAGE_WINDOW, MetricType.OCV],
            "mV": [MetricType.VOLTAGE_WINDOW, MetricType.OCV],
            "mg/cm²": [MetricType.MASS_LOADING],
            "g/m²": [MetricType.MASS_LOADING],
            "m/min": [MetricType.COATING_SPEED],
            "mm/s": [MetricType.COATING_SPEED],
        }
...
class RegexQuantExtractor:
    """Fast regex-based extraction of numerical battery metrics."""

    METRIC_PATTERNS: Dict[MetricType, List[str]] = {
        MetricType.GRAVIMETRIC_ENERGY_DENSITY: [
            r'energy\s+density',
            r'gravimetric\s+energy',
            r'specific\s+energy',
            r'wh\s*/\s*kg',
        ],
        MetricType.VOLUMETRIC_ENERGY_DENSITY: [
            r'volumetric\s+energy\s+density',
            r'wh\s*/\s*l',
            r'wh\s*/\s*liter',
        ],
        MetricType.SPECIFIC_CAPACITY: [
            r'specific\s+capacity',
            r'discharge\s+capacity',
            r'charge\s+capacity',
            r'reversible\s+capacity',
            r'mah\s*/\s*g',
        ],
        MetricType.AREAL_CAPACITY: [
            r'areal\s+capacity',
            r'mah\s*/\s*cm[²2]',
        ],
        MetricType.CYCLE_LIFE: [
            r'cycle\s+life',
            r'cycling\s+life',
            r'cycles?\s+to\s+\d+\s*%',
            r'\d+\s+cycles?',
        ...
        MetricType.CAPACITY_RETENTION: [
            r'capacity\s+retention',
            r'retention\s+(?:of|at)\s+\d+\s*%',
            r'retains?\s+\d+\s*%',
        ],
        MetricType.COULOMBIC_EFFICIENCY: [
            r'coulombic\s+efficiency',
            r'ce\s+(?:of|at|=)',
            r'charge\s+efficiency',
        ],
        MetricType.FIRST_CYCLE_EFFICIENCY: [
            r'first[\s-]cycle\s+efficiency',
            r'initial\s+coulombic\s+efficiency',
            r'ice',
            r'first[\s-]cycle\s+ce',
        ],
        MetricType.C_RATE: [
            r'\d+[./]?\d*\s*[cC](?![a-zA-Z])',
            r'c[\s-]?rate',
        ],
        MetricType.THERMAL_STABILITY_TEMP: [
            r'thermal\s+stability',
            r'decomposition\s+temperature',
            r'onset\s+temperature',
            r'thermal\s+runaway\s+(?:at|onset)',
        ],
        MetricType.OPERATING_TEMP_RANGE: [
            r'operating\s+temperature',
            r'operation\s+temp',
            r'working\s+temperature',
        ],
        MetricType.IMPEDANCE: [
            r'impedance',
            r'charge\s+transfer\s+resistance',
            r'sei\s+resistance',
            r'rct',
        ],
        MetricType.INTERNAL_RESISTANCE: [
            r'internal\s+resistance',
            r'dc\s+resistance',
            r'dcr',
        ],
        MetricType.ELECTRODE_DENSITY: [
            r'electrode\s+density',
            r'compaction\s+density',
            r'tap\s+density',
            r'packing\s+density',
        ],
        MetricType.POROSITY: [
        ...
        MetricType.ELECTRODE_THICKNESS: [
            r'electrode\s+thickness',
            r'coating\s+thickness',
            r'film\s+thickness',
        ],
        MetricType.PARTICLE_SIZE: [
            r'particle\s+size',
            r'grain\s+size',
            r'crystallite\s+size',
            r'd[0-9]+',
        ],
        MetricType.IONIC_CONDUCTIVITY: [
            r'ionic\s+conductivity',
            r'li[+⁺]\s+conductivity',
            r'ion\s+conductivity',
        ],
        MetricType.ELECTRONIC_CONDUCTIVITY: [
            r'electronic\s+conductivity',
            r'electron[ic]?\s+conductivity',
        ],
        MetricType.VOLTAGE_WINDOW: [
            r'voltage\s+window',
            r'voltage\s+range',
            r'operating\s+voltage',
        ],
        MetricType.OCV: [
            r'open[\s-]circuit\s+voltage',
            r'ocv',
            r'rest\s+voltage',
        ],
        MetricType.NP_RATIO: [
            r'n\s*/\s*p\s*ratio',
            r'n/p\s*ratio',
            r'capacity\s+balance',
            r'anode\s*[/to]\s*cathode\s*ratio',
        ],
        MetricType.CAPACITY_FADE_RATE: [
            r'capacity\s+fade\s+rate',
            r'fade\s+rate',
            r'capacity\s+decay',
        ],
        MetricType.MASS_LOADING: [
            r'mass\s+loading',
            r'areal\s+loading',
            r'coating\s+weight',
        ],
        MetricType.VOLUME_EXPANSION: [
            ...
            r'volumetric\s+expansion',
            r'volume\s+change',
        ],
    }

    MATERIAL_PATTERNS: List[Tuple[str, str, str]] = [
        (r'\bnmc\s*811\b', "NMC811", "cathode"),
        (r'\bnmc\s*622\b', "NMC622", "cathode"),
        (r'\bnmc\s*532\b', "NMC532", "cathode"),
        (r'\bnmc\s*333\b', "NMC333", "cathode"),
        (r'\blfp\b|\blifepo4\b', "LFP", "cathode"),
        (r'\blco\b|\blicoo2\b', "LCO", "cathode"),
        (r'\bnca\b', "NCA", "cathode"),
        (r'\bsilicon\b|\bsi[\s-]based\b|\bsi\s*anode\b', "Silicon", "anode"),
        (r'\bgraphite\b', "Graphite", "anode"),
        (r'\bsiox\b|\bsi[o0]x?\b', "SiOx", "anode"),
        (r'\bli[\s-]?metal\b|\bli[\s-]anode\b', "Lithium Metal", "anode"),
        (r'\blto\b|\bli4ti5o12\b', "LTO", "anode"),
        (r'\bsolid[\s-]?state\b|\bsse\b|\bsolid[\s-]electrolyte\b', "Solid Electrolyte", "electrolyte"),
        (r'\bfec\b|\bfluoroethylene\b', "FEC", "electrolyte"),
        (r'\bvc\b|\bvinylene\b', "VC", "electrolyte"),
    ]

    MODIFICATION_PATTERNS = [
        (r'coated|coating', "coated"),
        (r'doped|doping', "doped"),
        (r'surface[\s-]modified', "surface-modified"),
        (r'prelithiat', "prelithiated"),
        (r'carbon[\s-]coated', "carbon-coated"),
        (r'al2o3[\s-]coated', "Al₂O₃-coated"),
        (r'zro2[\s-]coated', "ZrO₂-coated"),
    ]
    ...
    def extract_conditions(cls, text: str) -> TestConditions:
        ...
        temp_range_match = re.search(
            r'(\d+(?:[.,]\d+)?)\s*[-–—to]+\s*(\d+(?:[.,]\d+)?)\s*[°o]C',
            text, re.IGNORECASE
        )
        if temp_range_match:
            conditions.temperature = ValueRange(
                float(temp_range_match.group(1)),
                float(temp_range_match.group(2)),
                is_range=True,
            )
        crate_match = re.search(r'(?:at\s*)?(\d+(?:[./]?\d+)?)\s*[cC](?![a-zA-Z])', text)
        if crate_match:
            rate_str = crate_match.group(1).replace(",", ".")
            conditions.c_rate = float(rate_str)
        vrange_match = re.search(
            r'(\d+(?:[.,]\d+)?)\s*[-–—to]+\s*(\d+(?:[.,]\d+)?)\s*V(?!\w)',
            text, re.IGNORECASE
        )
        if vrange_match:
            conditions.voltage_range = (
                float(vrange_match.group(1)),
                float(vrange_match.group(2)),
            )
        if re.search(r'coin[\s-]?cell|cr2032', text, re.IGNORECASE):
            conditions.cell_format = "coin"
        elif re.search(r'pouch[\s-]?cell|soft[\s-]?pack', text, re.IGNORECASE):
            conditions.cell_format = "pouch"
        elif re.search(r'cylindrical|18650|21700|4680', text, re.IGNORECASE):
            conditions.cell_format = "cylindrical"
        cycle_match = re.search(r'after\s*(\d+)\s*cycles?', text, re.IGNORECASE)
        if cycle_match:
            conditions.cycle_number = int(cycle_match.group(1))
        return conditions
                ...
                for match in re.finditer(pattern, text_lower):
                    ...
                    if unit:
                        ...
                        if converted is None:
                            # Unit is incompatible with metric type (e.g. 'nm' for 'energy density')
                            continue 
                    ...
                    entity = BatteryQuantEntity(
                        ...
                        conditions=conditions if any([
                            conditions.temperature, conditions.c_rate,
                            conditions.voltage_range, conditions.cell_format
                        ]) else None,
    ...
    def _extract_value_from_window(cls, window: str) -> Tuple:
        ...
        # Guard: skip numbers that are part of material names (e.g., NMC811, LFP123, etc.)
        if num_match:
            ...
            material_prefixes = ['NMC', 'NCA', 'LFP', 'LCO', 'LTO', 'SIO', 'FEC', 'VC']
            ...
            if any(suffix in after for suffix in ['cathode', 'anode', 'electrode', 'battery', 'cell']):
                # Only skip if no unit is found nearby
                if not re.search(r'(wh/kg|mah/g|cycles|°c|μm|nm|mm|g/cm³|mS/cm|V|Ω|%)', window[num_match.end():num_match.end()+20], re.I):
                    return None, None, False, False, False, False
            ...
            # Fallback: look for unit immediately before the number (e.g., "Wh/kg of 250")
            if not unit:
    ...
    def _extract_by_unit_pattern(cls, text: str) -> List[BatteryQuantEntity]:
        entities = []
        unit_patterns = [
            (r'(\d+(?:[.,]\d+)?)\s*[-–—]\s*(\d+(?:[.,]\d+)?)\s*(wh\s*/\s*kg|wh\s*/\s*l|mah\s*/\s*g|mah\s*/\s*cm[²2]|w\s*/\s*kg|%|cycles?|[°o]c|mΩ|Ω|g\s*/\s*cm[³3]|μm|um|nm|m[ms]\s*/\s*cm|v|mg\s*/\s*cm[²2])',
             True),
            (r'(\d+(?:[.,]\d+)?)\s*(wh\s*/\s*kg|wh\s*/\s*l|mah\s*/\s*g|mah\s*/\s*cm[²2]|w\s*/\s*kg|%|cycles?|[°o]c|mΩ|Ω|g\s*/\s*cm[³3]|μm|um|nm|m[ms]\s*/\s*cm|v|mg\s*/\s*cm[²2])',
             False),
        ]
...
class BatteryTokenizer:
    ...
    def _build_default_vocab(self) -> Dict[str, int]:
        vocab = {
            ...
            "<RANGE>": 4, "<DEG_C>": 5, "<PCT>": 6, "<OHM>": 7,
            "<MOHM>": 8, "<UM>": 9, "<SQ>": 10, "<CU>": 11, "<PLUS>": 12,
        }
        terms = [
            "energy", "density", "gravimetric", "volumetric", "specific",
            "capacity", "power", "cycle", "life", "retention", "efficiency",
            "coulombic", "first", "initial", "rate", "impedance", "resistance",
            "internal", "thickness", "porosity", "tortuosity", "conductivity",
            "ionic", "electronic", "voltage", "window", "open", "circuit",
            "ocv", "loading", "mass", "areal", "compaction", "particle",
            "size", "grain", "crystallite", "expansion", "volume", "fade",
            "decomposition", "onset", "thermal", "stability", "operating",
            "temperature", "pressure", "transference", "number", "ratio",
            "np", "balance", "coating", "speed",
            "nmc", "nmc811", "nmc622", "nmc532", "nmc333", "lfp", "lifepo4",
            "lco", "licoo2", "nca", "silicon", "si", "graphite", "siox",
            "sio", "lithium", "metal", "li", "lto", "li4ti5o12",
            "electrolyte", "solid", "liquid", "fec", "fluoroethylene",
            "carbonate", "vc", "vinylene", "lipf6", "salt", "solvent",
            "cathode", "anode", "positive", "negative", "electrode",
            "separator", "current", "collector",
            "calendering", "calender", "compaction", "pressing", "coating",
            "slot", "die", "dry", "solvent", "free", "doping", "doped",
            "surface", "modification", "prelithiation", "prelithiated",
            "formation", "annealing", "sintering",
            "wh", "kg", "l", "mah", "ah", "cm", "w", "kw", "cycles",
            "c", "v", "mv", "g", "mg", "nm", "mm", "ms", "s", "m",
            "min", "years", "months", "days", "k",
            "high", "low", "theoretical", "practical", "measured",
            "reported", "achieved", "obtained", "reached", "exhibited",
            "demonstrated", "showed", "delivered", "maintained",
            "approximately", "about", "around", "roughly", "nearly",
            "up", "to", "maximum", "minimum", "at", "least", "exceeding",
            "over", "more", "than", "below", "above", "between",
            "compared", "higher", "lower", "similar", "exceeds", "surpasses",
            "after", "before", "during", "at", "under", "with", "without",
            "using", "in", "of", "for", "by", "from", "per",
            "and", "or", "but", "however", "while", "although",
            "the", "a", "an", "this", "that", "which", "whose",
...
class NEREntityConverter:
    METRIC_NAME_MAP = {
        "energy density": MetricType.GRAVIMETRIC_ENERGY_DENSITY,
        "gravimetric energy": MetricType.GRAVIMETRIC_ENERGY_DENSITY,
        "specific energy": MetricType.GRAVIMETRIC_ENERGY_DENSITY,
        "volumetric energy": MetricType.VOLUMETRIC_ENERGY_DENSITY,
        "specific capacity": MetricType.SPECIFIC_CAPACITY,
        "discharge capacity": MetricType.SPECIFIC_CAPACITY,
        "charge capacity": MetricType.SPECIFIC_CAPACITY,
        "areal capacity": MetricType.AREAL_CAPACITY,
        "cycle life": MetricType.CYCLE_LIFE,
        "capacity retention": MetricType.CAPACITY_RETENTION,
        "coulombic efficiency": MetricType.COULOMBIC_EFFICIENCY,
        "first cycle efficiency": MetricType.FIRST_CYCLE_EFFICIENCY,
        "initial efficiency": MetricType.FIRST_CYCLE_EFFICIENCY,
        "power density": MetricType.GRAVIMETRIC_POWER_DENSITY,
        "c rate": MetricType.C_RATE,
        "impedance": MetricType.IMPEDANCE,
        "internal resistance": MetricType.INTERNAL_RESISTANCE,
        "electrode density": MetricType.ELECTRODE_DENSITY,
        "compaction density": MetricType.COMPACTION_DENSITY,
        "porosity": MetricType.POROSITY,
        "thickness": MetricType.ELECTRODE_THICKNESS,
        "particle size": MetricType.PARTICLE_SIZE,
        "ionic conductivity": MetricType.IONIC_CONDUCTIVITY,
        "electronic conductivity": MetricType.ELECTRONIC_CONDUCTIVITY,
        "voltage window": MetricType.VOLTAGE_WINDOW,
        "open circuit voltage": MetricType.OCV,
        "ocv": MetricType.OCV,
        "mass loading": MetricType.MASS_LOADING,
        "volume expansion": MetricType.VOLUME_EXPANSION,
        "thermal stability": MetricType.THERMAL_STABILITY_TEMP,
        "decomposition temperature": MetricType.THERMAL_STABILITY_TEMP,
        "np ratio": MetricType.NP_RATIO,
        "capacity fade": MetricType.CAPACITY_FADE_RATE,
        "tortuosity": MetricType.TORTUOSITY,
        "transference number": MetricType.TRANSFERENCE_NUMBER,
    }
    MATERIAL_ROLE_MAP = {
        "nmc811": "cathode", "nmc622": "cathode", "nmc532": "cathode",
        "nmc333": "cathode", "lfp": "cathode", "lifepo4": "cathode",
        "lco": "cathode", "nca": "cathode",
        "silicon": "anode", "si": "anode", "graphite": "anode",
        "siox": "anode", "sio": "anode", "lithium": "anode",
        "li": "anode", "lto": "anode",
        "fec": "electrolyte", "vc": "electrolyte",
...
def render_quantitative_tab() -> None:
    ...
    st.caption(
        "Extract, normalize, and predict numerical battery metrics using "
    ...
    if input_mode == "Use Microtransformer Query":
        ...
        text = st.text_area(
            "Enter battery research text:",
            height=150,
            placeholder="e.g., The NMC811 cathode with Al₂O₃ coating achieved 250 Wh/kg energy density and 180 mAh/g specific capacity at 0.5C rate...",
        )
        ...
        samples = [
            "The Si/graphite composite anode achieved 450 mAh/g specific capacity and maintained 85% capacity retention after 500 cycles. The cell exhibited 280 Wh/kg energy density with 99.5% coulombic efficiency.",
            "NMC811 cathode with ZrO₂ coating showed thermal stability up to 250°C and delivered 195 mAh/g at 0.2C. The impedance increased from 15 mΩ to 45 mΩ after 200 cycles.",
            "Solid-state battery using Li6PS5Cl electrolyte achieved 350 Wh/kg with lithium metal anode. The ionic conductivity was 3.2 mS/cm at room temperature. Cycle life exceeded 1000 cycles with 90% retention.",
            "LFP/graphite pouch cell demonstrated 160 Wh/kg, 2000 cycle life at 1C, and operated from -20°C to 60°C. First cycle efficiency was 92% and capacity fade rate was 0.02%/cycle.",
            "Calendering the NMC622 electrode to 3.2 g/cm³ density increased volumetric energy density to 550 Wh/L while maintaining 95% porosity for ionic transport. Mass loading was 25 mg/cm².",
        ]

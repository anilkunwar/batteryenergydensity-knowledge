...
def render_microtransformer_kg_rag_tab(analysis_data: Dict, ontology: DomainOntology) -> None:
    ...
    quick_query = st.text_input("Or type a query to auto-select source/target (e.g., 'How does calendering affect energy density?')", key="mt_quick_query")
    if quick_query:
    ...
    # 2. Bar chart — FIXED: no legend overlap, proper trace naming
...
# ============================================================================
# QDWA VISUALIZATION MODULE — Enhanced with Dynamic Customizations
# ============================================================================
...
def render_qdwa_full_dashboard(
    ...
    st.markdown("---")
    render_qdwa_energy_density_score(analysis, custom_params=custom_params)
    st.markdown("---")

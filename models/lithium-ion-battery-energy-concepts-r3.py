...
# ==========================================
# SIMPLE, ROBUST DEPENDENCY HANDLING (CLOUD-OPTIMIZED)
# ==========================================
def ensure_package(package_name: str, pip_name: str = None):
    """Minimal installer – only for truly missing packages on cold start."""
    try:
...
# Install only if truly missing (Streamlit Cloud usually has torch)
ensure_package("torch")
ensure_package("dgl", "dgl==2.2.1")   # GraphBolt version – NO torchdata dependency
ensure_package("sentence_transformers", "sentence-transformers")
ensure_package("transformers")
ensure_package("networkx")
ensure_package("pyvis")
...
def main():
    ...
    with st.sidebar:
        ...
        st.slider("Min Concept Frequency", 2, 10, 3, key="min_freq", help="Lower for smaller datasets")
